...
public class JunitHTMLReporter {
	...
	public static void setUpBeforeClass() throws IOException
	{
		...
		String junitReportFile = "C:\\Users\\Rajendra.Babu\\eclipse-workspace\\JunitProject\\JUnitReportFile.html";
		...
		junitWriter.write("<h1> Text Execution Summary " + dateFormat.format(date) + "</h1>");
